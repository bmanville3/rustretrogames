...
impl SnakeSelectionViewModel {
    ...
    #[must_use]
    pub fn validate_grid_to_player(&self, grid_size: usize, number_of_total_players: usize) -> bool {
        grid_size >= self.get_min_grid_size(number_of_total_players)
    }

    #[must_use]
    pub fn validate_all(&self, grid_size: usize, number_of_bots: usize, number_of_real_players: usize) -> bool {
